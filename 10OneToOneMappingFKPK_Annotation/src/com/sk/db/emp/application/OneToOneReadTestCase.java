...
public class OneToOneReadTestCase {
	...
	public static void main(String[] args) {
		...
		System.out.print("Please Enter Identity (EmployeeID/PersonalID):");
		int id = readData.nextInt();
		System.out.println("Searching For Employee Details For EmployeeID:" + id);
	...
	private static void testReadEmployee(int empID) {
		try {
			...
			System.out.println("Employee Object Inside PersonalDetails Is : " + empObject.getPersonalDetail().getEmployee());
		} catch (Exception ex) {
